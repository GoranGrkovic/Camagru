    ...
    <div class="hero level-left">
            <div id="screenshot" class="montage" style="text-align:center;">
                <div id="video">
                    ...
                    <div class="images">
                        <div id="9" class="filter filter1" style="width: 150px; height: 150px; background-size:contain;background-image: url('./application/img/montage/min/min_lounys_1.jpg');"></div>
                        <div id="1" class="filter filter1" style="width: 150px; height: 150px; background-size:contain;background-image: url('./application/img/montage/min/min_lounys_2.jpg');"></div>
                        <div id="3" class="filter filter3" style="width: 150px; height: 150px; background-size:contain;background-image: url('./application/img/montage/min/min_pingouin_3.jpg');"></div>
                        <div id="4" class="filter filter4" style="width: 150px; height: 150px; background-size:contain;background-image: url('./application/img/montage/min/min_pingouin_4.jpg');"></div>
                        <div id="5" class="filter filter5" style="width: 150px; height: 150px; background-size:contain;background-image: url('./application/img/montage/min/min_pingouin_5.jpg');"></div>
                        <div id="6" class="filter filter6" style="width: 150px; height: 150px; background-size:contain;background-image: url('./application/img/montage/min/min_pingouin_6.jpg');"></div>
                        <div id="7" class="filter filter7" style="width: 150px; height: 150px; background-size:contain;background-image: url('./application/img/montage/min/min_pingouin_7.jpg');"></div>
                    </div>
                    <div id="status"></div>
